...
public class employeePageController implements Initializable {
    ...
    @FXML
    TableColumn<Employee, String> tableEmployeeName;
    @FXML
    TableColumn<Employee, String> tablePosition;
    @FXML
    TableColumn<Employee, Double> tableSalary;
    @FXML
    TableColumn<Employee, String> tableUsername;
