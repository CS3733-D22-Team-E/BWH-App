...
public class DashboardTooltip extends DashboardHandler {
    ...
    public DashboardTooltip(MedicalEquipmentDAOImpl medicalEquipmentDAO, DashboardController dashboardController) {
    ...
    private void populateTooltip(Tooltip tooltip, String floor) throws SQLException {
        ...
        Integer cleanEquipment = filterEquipment(equipmentOnFloor, dashboardController.cleanFilter).size();
        Integer dirtyEquipment = filterEquipment(equipmentOnFloor, dashboardController.dirtyFilter).size();
        Integer inUseEquipment = filterEquipment(equipmentOnFloor, dashboardController.inUseFilter).size();
