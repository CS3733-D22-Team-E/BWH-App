...
public class DashboardTableViewHandler extends DashboardHandler {
    ...
    public DashboardTableViewHandler(MedicalEquipmentDAOImpl medicalEquipmentDAO, DashboardController dashboardController) {
    ...
    public void update() throws SQLException {
        ...
        displayEquipmentTable(dashboardController.currentFilter, dashboardController.currentFloor, dashboardController.equipmentSelectedFilter);
    }

    public void displayEquipmentTable(Toggle filter, String floor, String equipmentType) {
        try {
            ArrayList<MedicalEquipment> filteredEquipment = populateEquipmentList(filter, floor, equipmentType, this.allEquipment);
            ...
            dashboardController.tableLocation.setCellValueFactory(
                    new Callback<
                        ...
                        public ObservableValue<String> call(
                            ...
                            Location curEquipmentLocation = dashboardController.locationDAO.get(curEquipment.getCurrentLocation());
