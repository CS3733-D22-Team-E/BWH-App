...
public class GiftRequestDAOImpl implements DAO<giftDeliveryRequest> {
    ...
    public GiftRequestDAOImpl() throws SQLException {
        ...
        while (rs.next()) {
            ...
            giftDeliveryRequest request = new giftDeliveryRequest(giftReqID, otherNotes, floorID, roomID, isUrgent, status, staffAssignee, requestDate.toLocalDate(), deliveryDate.toLocalDate(), patientName, giftDeliveryRequest.Gift.valueOf(giftType));
