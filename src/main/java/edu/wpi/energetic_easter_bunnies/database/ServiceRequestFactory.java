...
public class ServiceRequestFactory {
    public serviceRequest getServiceRequest(String serviceRequestType) {
        ...
        else if(serviceRequestType.equalsIgnoreCase("LANG_INTERP_REQ")) return new languageInterpreterRequest();
        else if(serviceRequestType.equalsIgnoreCase("MEAL_DELIV_REQ")) return new mealDeliveryRequest();
