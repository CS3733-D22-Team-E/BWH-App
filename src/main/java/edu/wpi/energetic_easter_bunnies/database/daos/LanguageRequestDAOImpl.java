...
public class LanguageRequestDAOImpl implements DAO<languageInterpreterRequest> {
    ...
    public LanguageRequestDAOImpl() throws SQLException {
        ...
        while (rs.next()) {
            ...
            languageInterpreterRequest request = new languageInterpreterRequest(langInterpReqID, otherNotes, floorID, roomID, isUrgent, status, staffAssignee, languageInterpreterRequest.Language.valueOf(language), deliveryDate.toLocalDate(), requestDate.toLocalDate());
